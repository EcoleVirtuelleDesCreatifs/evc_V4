...
<!-- Loading Overlay during submission/email sending -->
        ...
        <form id="preRegistrationForm" novalidate>
            ...
            <div class="form-step active" data-step="1">
                ...
                <div class="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2">
                    ...
                    <input type="number" name="age" placeholder="Âge" min="16" required class="form-input">
                    <div class="sm:col-span-2">
                        <input type="file" name="photo" accept="image/*" required class="form-input">
                    </div>
                    <div class="sm:col-span-2"><input type="text" name="pays" placeholder="Pays" required class="form-input"></div>
                </div>
            </div>
            ...
            <div class="form-step" data-step="2">
                ...
                <div class="space-y-4">
                    ...
                    <!-- Niveau dans la formation choisie -->
                    <select name="niveau_dans_formation" required class="form-input">
                        <option selected disabled value="">Quel est votre niveau dans cette formation ?</option>
                        <option value="aucune_notion">Aucune notion</option>
                        <option value="quelques_notions">Quelques notions</option>
                        <option value="me_perfectionner">Me perfectionner</option>
                    </select>

                    <!-- Statut actuel (mappé sur 'disponibilite' côté backend) -->
                    <select name="disponibilite" required class="form-input">
                        <option selected disabled value="">Quel est votre statut actuel ?</option>
                        <option value="Salarie">Salarié</option>
                        <option value="Etudiant en quête de compétence">Étudiant en quête de compétence</option>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center gap-6">
                            <label class="inline-flex items-center gap-2">
                                <input type="radio" name="has_computer" value="1" required class="form-radio">
                                <span class="text-gray-300">Oui</span>
                            </label>
                            <label class="inline-flex items-center gap-2">
                                <input type="radio" name="has_computer" value="0" required class="form-radio">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center gap-6">
                            <label class="inline-flex items-center gap-2">
                                <input type="radio" name="has_smartphone" value="1" required class="form-radio">
                                <span class="text-gray-300">Oui</span>
                            </label>
                            <label class="inline-flex items-center gap-2">
                                <input type="radio" name="has_smartphone" value="0" required class="form-radio">
                                <span class="text-gray-300">Non</span>
                            </label>
                        </div>
                    </div>
