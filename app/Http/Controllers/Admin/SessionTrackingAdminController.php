...
class SessionTrackingAdminController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        try {
            ...
            Log::error('Session tracking table not available', [
                'error' => $e->getMessage(),
            ]);
            ...
            return view('admin.session-tracking.index', [
                ...
                'formations' => collect([]),
                'error' => 'Table de tracking non disponible. Veuillez exécuter les migrations.',
            ]);
        }
    }
    ...
    public function studentDetail(Request $request, int $studentId): View
    {
        ...
        try {
            ...
            Log::error('Session tracking table not available for student detail', [
                'error' => $e->getMessage(),
                'student_id' => $studentId,
            ]);
    ...
    public function export(Request $request)
    {
        ...
        try {
            ...
            Log::error('Session tracking table not available for export', [
                'error' => $e->getMessage(),
            ]);

            return response('Table de tracking non disponible. Veuillez exécuter les migrations.', 500)
