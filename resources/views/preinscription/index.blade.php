...
@section('title', 'Démarrer ma pré-inscription - EVC')
...
@section('content')
  ...
  <section class="bg-gray-900 py-12 border-b border-gray-800 pt-28 lg:pt-36">
    <div class="mx-auto max-w-4xl px-6 lg:px-8 text-center">
      <h1 class="text-3xl lg:text-4xl font-extrabold text-white">Démarrer ma pré‑inscription</h1>
      <p class="mt-3 text-gray-300">Merci de compléter soigneusement les étapes ci‑dessous. Tous les champs sont requis.</p>
    </div>
  </section>

  <!-- Formulaire pleine page (sans modale) -->
  <section class="py-10">
    <div class="mx-auto max-w-2xl px-6 lg:px-0">
      <div id="preinscription-form-container" class="relative bg-dark-secondary p-6 lg:p-8 rounded-2xl shadow-lg border border-gray-700 w-full">
