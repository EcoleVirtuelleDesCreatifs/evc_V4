        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Vos projets individuels de design graphique</p>
                </div>
                ...
                <div class="card-body">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('design-graphique.projets.show', $project['id']) }}" class="btn btn-sm btn-primary">
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <h5 class="text-muted">Aucun projet solo pour le moment</h5>
                            <p class="text-muted">Créez votre premier projet depuis la page principale</p>
                            <a href="{{ route('design-graphique.projets.index') }}" class="btn btn-primary mt-3">
