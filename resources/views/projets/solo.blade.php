...
@section('title', 'Projets Solo - Design Graphique')
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="h3 mb-0 text-gray-800">
                        <i class="fas fa-user me-2" style="color: #003366;"></i>
                        Mes Projets Solo
                    </h1>
                    <p class="text-muted mb-0">Liste complète de tous vos projets individuels</p>
                </div>
                <div>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">
                ...
                Liste des Projets Solo ({{ count($projects) }})
            </h6>
        </div>
        <div class="card-body">
            @if(count($projects) > 0)
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <h5 class="text-muted">Aucun projet solo trouvé</h5>
                    <p class="text-muted">Vous n'avez pas encore créé de projet solo.</p>
                    <a href="{{ route('design-graphique.projets.index') }}" class="btn btn-primary">
                        <i class="fas fa-plus me-2"></i>Créer mon premier projet solo
                    </a>
                </div>
            @endif
        </div>
