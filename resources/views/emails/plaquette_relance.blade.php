                ...
                <tr>
                    <td style="padding:26px 24px 8px 24px; color:#e5e7eb;">
                        ...
                        <div style="font-size:14px; line-height:1.6; margin:0; color:#cbd5e1;">
                            Vous avez récemment demandé notre plaquette pour la formation <strong style="color:#fbbf24;">{{ $request->type_formation ?? '' }}</strong>.<br>
                            Avez-vous fait votre choix ? Les inscriptions sont ouvertes et les places sont limitées.
                        </div>
                    </td>
                </tr>
                        ...
                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#0b1220; border:1px solid #1f2a44; border-radius:14px;">
                            <tr>
                                <td style="padding:16px 16px; color:#e5e7eb;">
                                    <div style="font-size:12px; color:#94a3b8; margin-bottom:6px;">Formation demandée</div>
                                    <div style="font-size:16px; font-weight:700; margin:0 0 2px 0; color:#ffffff;">{{ $request->type_formation ?? '—' }}</div>
                                    <div style="font-size:12px; color:#fbbf24;">{{ $request->pays ?? '' }}{{ $request->ville ? ' • ' . $request->ville : '' }}</div>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td style="padding:16px 24px; background:#0b1220; border-top:1px solid #1f2a44; color:#94a3b8;">
                        <div style="font-size:12px; line-height:1.6;">
                            Besoin d'aide pour vous inscrire ? Répondez simplement à cet email.<br>
                            Merci,<br>
