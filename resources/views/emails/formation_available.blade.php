...
<head>
    ...
    <title>Nouvelle formation disponible</title>
</head>
<body style="margin:0;padding:0;background:#f3f4f6;font-family:Arial,Helvetica,sans-serif;">
    <div style="max-width:640px;margin:0 auto;padding:24px;">
        <div style="background:linear-gradient(135deg,#1e3c72 0%,#2a5298 100%);border-radius:14px 14px 0 0;padding:22px 24px;color:#fff;">
            ...
            <div style="margin-top:6px;font-size:14px;opacity:.95;">Nouvelle formation disponible</div>
        </div>
        ...
        <div style="background:#ffffff;border-radius:0 0 14px 14px;padding:24px;border:1px solid #e5e7eb;border-top:none;">
            <p style="margin:0 0 12px 0;color:#111827;font-size:15px;line-height:1.6;">
                Bonjour <strong>{{ $recipientName ?? 'Cher(e) étudiant(e)' }}</strong>,
            </p>

            <p style="margin:0 0 16px 0;color:#374151;font-size:14px;line-height:1.6;">
                Une nouvelle formation est maintenant disponible dans votre espace.
            </p>

            <div style="border-left:4px solid #4fc3f7;background:#f8fafc;border-radius:10px;padding:14px 16px;margin:0 0 18px 0;">
                <div style="font-size:13px;color:#6b7280;margin-bottom:6px;">Formation</div>
                <div style="font-size:18px;color:#111827;font-weight:700;">{{ $formationName }}</div>
            ...
            @if(!empty($formationsUrl))
                <div style="text-align:center;margin:18px 0 6px 0;">
                    <a href="{{ $formationsUrl }}"
                ...
                <p style="margin:10px 0 0 0;color:#6b7280;font-size:12px;line-height:1.5;">
                    ...
                    <span style="word-break:break-all;">{{ $formationsUrl }}</span>
                </p>
            @endif
            ...
            <p style="margin:0;color:#6b7280;font-size:12px;line-height:1.5;">
                Cet email vous a été envoyé automatiquement par la plateforme EVC.
            </p>
        </div>
    </div>
</body>
