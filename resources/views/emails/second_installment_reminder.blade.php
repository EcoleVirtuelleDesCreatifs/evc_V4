                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="color: #475569; line-height: 1.8; margin: 20px 0; font-size: 16px;">
                                ...
                                @endphp
                                Pour finaliser complètement votre inscription à la formation <strong style="color: #2563eb;">{{ $formationDisplay }}</strong>, il vous reste à régler la 2ème et dernière tranche.
                            </p>
