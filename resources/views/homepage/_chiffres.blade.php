...
<div id="chiffres" class="bg-gradient-to-br from-[#0a1128] via-[#001f54] to-[#034078] py-24 sm:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:max-w-none">
            <div class="text-center" data-aos="fade-up">
                <h2 class="text-3xl font-bold tracking-tight text-white sm:text-4xl">Un impact chiffré, une réalité vécue</h2>
                <p class="mt-4 text-lg leading-8 text-gray-300">Les résultats parlent d'eux-mêmes :</p>
            </div>
            ...
            <div class="mt-10 text-center text-lg text-gray-300" data-aos="fade-up" data-aos-delay="500">
                <p>EVC, <span class="font-bold bg-gradient-to-r from-orange-400 via-orange-500 to-orange-600 bg-clip-text text-transparent">1ère École Digitale Ultra-Pratique</span> en Afrique Francophone.</p>
            </div>
        </div>
    </div>
</div>
