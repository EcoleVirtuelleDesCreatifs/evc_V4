...
<div id="popup-preinscription" class="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-[9999] hidden opacity-0 transition-opacity duration-500">
    <div class="relative bg-gradient-to-br from-[#001f54] via-[#034078] to-[#001f54] rounded-3xl shadow-2xl max-w-2xl w-full mx-4 overflow-hidden transform scale-95 transition-transform duration-500" id="popup-content">
        ...
        <div class="relative p-8 md:p-12">
            ...
            <div class="flex justify-center mb-6">
                <div class="w-20 h-20 bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl flex items-center justify-center shadow-lg animate-bounce-slow">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                <div class="flex items-start gap-3 bg-white/5 p-4 rounded-xl backdrop-blur-sm">
                ...
                <div class="flex items-start gap-3 bg-white/5 p-4 rounded-xl backdrop-blur-sm">
                    ...
                    <div>
                        <h3 class="text-white font-semibold mb-1">En Ligne et En Présentiel</h3>
                        <p class="text-gray-400 text-sm">Formation 100% Ultra-pratique</p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-3 bg-white/5 p-4 rounded-xl backdrop-blur-sm">
                    ...
                    <div>
                        <h3 class="text-white font-semibold mb-1">Suivi Personnalisé</h3>
                        <p class="text-gray-400 text-sm">Accompagnement individuel</p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-3 bg-white/5 p-4 rounded-xl backdrop-blur-sm">
                    ...
                    <div>
                        <h3 class="text-white font-semibold mb-1">Insertion Pro</h3>
                        <p class="text-gray-400 text-sm">+90 étudiants embauchés</p>
                    </div>
                </div>
            </div>

            <!-- Urgence -->
            <div class="bg-orange-500/10 border border-orange-500/30 rounded-xl p-4 mb-6 text-center">
                <p class="text-orange-400 font-semibold mb-1">
            ...
            <div class="flex flex-col sm:flex-row gap-4">
                <a href="{{ route('preinscription.start') }}" class="flex-1 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-bold py-4 px-6 rounded-xl text-center transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-orange-500/50">
                    <i class="fas fa-rocket mr-2"></i>
                    Je M'inscris Maintenant
                </a>
                <button id="later-popup" class="flex-1 bg-white/10 hover:bg-white/20 text-white font-semibold py-4 px-6 rounded-xl transition-all duration-300 border border-white/20">
                    Plus Tard
                </button>
            </div>
