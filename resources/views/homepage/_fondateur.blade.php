...
<div class="py-24 sm:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:text-center mb-16">
            ...
            <p class="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">Bilé Bossombra</p>
        </div>
                ...
                <div class="card-face card-front">
                    <div class="relative overflow-hidden rounded-3xl shadow-2xl h-full">
                        ...
                        <div class="absolute bottom-0 left-0 p-6">
                            <h3 class="text-2xl font-bold text-white">Bilé Bossombra</h3>
                            <p class="text-orange-400">Cliquez pour découvrir</p>
                        </div>
                    </div>
                </div>
                <!-- Back Face -->
