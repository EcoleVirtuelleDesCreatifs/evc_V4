...
<div class="bg-black py-20 sm:py-24 relative overflow-hidden" id="international-students-section">
    ...
    <div class="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-3xl text-center">
            ...
            <p class="mt-4 text-lg leading-8 text-gray-300">Depuis sa création, l'Ecole Virtuelle des Créatifs (EVC) a attiré des étudiants de divers horizons, témoignant de son attractivité et de la qualité de ses programmes.</p>
        </div>
        <div class="mt-16 flex justify-center">
            <div class="flex flex-wrap justify-center gap-4 sm:gap-6">
                ...
                @foreach ($countries as $index => $country)
                    <div class="relative group" data-aos="fade-up" data-aos-delay="{{ $index * 50 }}">
