        ...
        <div class="grid grid-cols-1 gap-12 lg:grid-cols-4 lg:gap-8">
            ...
            <div>
                ...
                <ul role="list" class="space-y-3">
                    ...
                    <li>
                        <a href="{{ \Illuminate\Support\Facades\Route::has('activity-reports.index') ? route('activity-reports.index') : url('/rapports-activite') }}" class="group flex items-center text-sm text-gray-300 hover:text-orange-400 transition-colors">
                            <i class="fas fa-chevron-right text-orange-500 text-xs mr-2 group-hover:translate-x-1 transition-transform"></i>
                            Rapports d'activité
                        </a>
                    </li>
