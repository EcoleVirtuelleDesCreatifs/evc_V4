        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 mb-3">
                <div class="report-card text-center">
                    ...
                    <p class="text-white mb-3" style="opacity: 0.85;">Statistiques complètes sur les étudiants inscrits et leur progression</p>
            ...
            <div class="col-lg-3 col-md-6 mb-3">
                <div class="report-card text-center">
                    ...
                    <p class="text-white mb-3" style="opacity: 0.85;">Performance des formations, modules et taux de réussite</p>
            ...
            <div class="col-lg-3 col-md-6 mb-3">
                <div class="report-card text-center">
                    ...
                    <p class="text-white mb-3" style="opacity: 0.85;">Revenus, paiements et analytics financières détaillées</p>
            ...
            <div class="col-lg-3 col-md-6 mb-3">
                <div class="report-card text-center">
                    ...
                    <p class="text-white mb-3" style="opacity: 0.85;">TP, projets et activités des étudiants par formation</p>
...
function downloadReport(reportId) {
    window.open(`/evc/app/admin/rapports/download/${reportId}`, '_blank');
}
