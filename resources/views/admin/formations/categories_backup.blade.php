...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card border-0" style="background: rgba(255,255,255,0.05); backdrop-filter: blur(10px); border-radius: 20px; border: 1px solid rgba(255,255,255,0.1);">
                <div class="card-header" style="background: rgba(255,255,255,0.1); border-bottom: 1px solid rgba(255,255,255,0.1); border-radius: 20px 20px 0 0;">
                    <h5 class="mb-0 text-white fw-bold"><i class="fas fa-chart-pie me-2"></i>Statistiques par Module</h5>
                </div>
                <div class="card-body p-4">
                    <div class="row g-3">
                        @php
                        ...
                        @foreach($moduleColors as $moduleSlug => $moduleData)
                            @php
                                $stats = $statsByModuleWithFormations[$moduleSlug] ?? null;
                                $categoriesCount = $stats->categories_count ?? 0;
                                $formationsCount = $stats->formations_count ?? 0;
                            @endphp
                            <div class="col-md-6 col-lg-3">
                                <div class="card h-100 border-0" style="background: {{ $moduleData['bg'] }}; border-radius: 15px; overflow: hidden;">
                                    <div class="card-body text-white p-4">
                                        <div class="d-flex justify-content-between align-items-start mb-3">
                                            <div class="flex-grow-1">
                                                <h6 class="text-white-50 text-uppercase mb-2" style="font-size: 0.75rem; letter-spacing: 1px;">
                                                    {{ $moduleData['name'] }}
                                                </h6>
                                                <h2 class="mb-0 fw-bold" style="font-size: 2.5rem;">{{ $categoriesCount }}</h2>
                                                <p class="mb-0 mt-1" style="font-size: 0.9rem;">Catégorie(s)</p>
                                            </div>
