...
@section('title', 'Candidatures - Formateurs')
...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-white">Candidatures Formateurs</h1>
                    ...
                    <tbody>
                        @forelse($candidatures as $c)
                            <tr>
                                ...
                                <td class="text-end">
                                    <a class="btn btn-sm btn-info" href="{{ route('admin.candidatures.formateurs.show', $c->id) }}">Voir</a>
                                </td>
                            </tr>
                        @empty
                            <tr>
