...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0">Candidature Collaborateur #{{ $candidature->id }}</h2>
        <a class="btn btn-secondary" href="{{ route('admin.candidatures.collaborateurs.index') }}">Retour</a>
    </div>
        ...
        <div class="col-lg-8">
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <div class="border rounded p-3">{{ $candidature->message }}</div>
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <div class="d-grid gap-2 mt-3">
                        <a class="btn btn-outline-primary" href="{{ route('admin.candidatures.collaborateurs.download-cv', $candidature->id) }}">Télécharger CV</a>
