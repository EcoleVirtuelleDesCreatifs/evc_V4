                ...
                <form method="POST" action="{{ route('admin.jury-members.update', $juryMember) }}" enctype="multipart/form-data">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <div class="toggle-wrap" onclick="var cb=document.getElementById('is_active');cb.checked=!cb.checked;cb.dispatchEvent(new Event('change'));">
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <div class="toggle-wrap" onclick="var cb=document.getElementById('is_visible');cb.checked=!cb.checked;cb.dispatchEvent(new Event('change'));">
