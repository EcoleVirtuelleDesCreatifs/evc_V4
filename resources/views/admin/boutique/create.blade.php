...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Ajoutez un nouveau produit à la boutique EVC Store</p>
        </div>
        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control modern-input @error('summary') is-invalid @enderror"
                                   id="summary" name="summary" value="{{ old('summary') }}" maxlength="500"
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-4">
                                ...
                                <input type="number" class="form-control modern-input @error('old_price') is-invalid @enderror"
                                       id="old_price" name="old_price" value="{{ old('old_price') }}" min="0"
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control modern-input @error('variants') is-invalid @enderror"
                                      ...
                                      placeholder='[{"label":"Couleur","options":["Rouge","Bleu"]},{"label":"Taille","options":["S","M","L"]}]'>{{ old('variants') }}</textarea>
                            @error('variants')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="card-body">
                        <div class="mb-4">
                            ...
                            <textarea class="form-control modern-input @error('seo_geo') is-invalid @enderror"
                                      ...
                                      placeholder="Mots-clés, ville, pays...">{{ old('seo_geo') }}</textarea>
                            @error('seo_geo')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
            ...
            <div class="col-lg-4">
                        ...
                        <div class="mb-4">
                            ...
                            <div id="delivery-zones-container">
                                @php
                                    ...
                                    $zones = old('delivery_zones') ?: $defaultZones;
                                @endphp
                ...
                <div class="card modern-card mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <label for="images" class="form-label">Images du carousel</label>
                            <input type="file" class="form-control modern-input @error('images.*') is-invalid @enderror"
                                   id="images" name="images[]" accept="image/*" multiple>
                            @error('images.*')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="text-muted d-block mt-2">Sélectionnez une ou plusieurs images. La première sera l'image principale.</small>
                        </div>

                        <div id="image-preview" class="mt-3" style="display: none;">
                            <div id="preview-images" class="d-flex flex-wrap gap-2"></div>
                            <button type="button" class="btn btn-sm btn-outline-danger mt-2" id="remove-images">
