                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="old_price" id="old_price" class="form-control @error('old_price') is-invalid @enderror" value="{{ old('old_price', $product->old_price) }}" min="0">
                            @error('old_price')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="variants" id="variants" class="form-control @error('variants') is-invalid @enderror" rows="4" placeholder='[{"label":"Couleur","options":["Rouge","Bleu"]},{"label":"Taille","options":["S","M","L"]}]'>{{ old('variants', $product->variants ? json_encode($product->variants) : '') }}</textarea>
                            @error('variants')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
