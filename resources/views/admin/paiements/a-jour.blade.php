                        ...
                        <tbody>
                            @forelse($students as $student)
                                <tr>
                                    ...
                                    <td>
                                        <strong
                                            class="text-success">{{ number_format($student->amount_paid, 0, ',', ' ') }}
                                            FCFA</strong>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        @if (!empty($student->pre_registration_id))
                                            <a href="{{ route('admin.paiements.receipt', $student->pre_registration_id) }}"
                                                class="btn btn-sm btn-secondary" title="Télécharger le reçu"
                                                target="_blank">
