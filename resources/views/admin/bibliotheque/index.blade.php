                            ...
                            <tr class="media-row"
                                ...
                                <td>
                                    @if($item->cover_image)
                                        ...
                                        <img src="{{ \App\Models\MediaUrl::fromPath($item->cover_image) }}" alt="{{ $item->title }}" width="80" class="rounded shadow-sm">
                                    @elseif(in_array(strtolower($item->file_type), ['jpg', 'jpeg', 'png', 'gif', 'svg', 'webp']))
                                        ...
                                        <img src="{{ \App\Models\MediaUrl::fromPath($item->path) }}" alt="{{ $item->title }}" width="80" class="rounded shadow-sm">
                                    @else
                                ...
                                <td>
                                    <a href="{{ \App\Models\MediaUrl::fromPath($item->path) }}" target="_blank" class="text-white">{{ $item->title }}</a>
                                </td>
