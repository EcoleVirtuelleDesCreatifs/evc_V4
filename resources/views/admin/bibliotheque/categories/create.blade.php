...
@section('title', 'Créer une Catégorie de Bibliothèque')

@section('content')
<div class="container-fluid py-4">
    <h1 class="text-white mb-4">Créer une Nouvelle Catégorie</h1>

    <div class="card" style="background-color: #1e293b; border: 1px solid #334155;">
        <div class="card-body">
            <form action="{{ route('admin.bibliotheque.categories.store') }}" method="POST">
                @csrf
                <div class="mb-3">
