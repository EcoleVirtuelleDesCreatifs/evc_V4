    ...
    <div class="works-header fade-in">
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
            <div class="d-flex align-items-center gap-3">
                <a href="{{ route('admin.students.profile', $data['student']['id']) }}" class="text-white text-decoration-none" title="Retour au profil">
            ...
            <a href="{{ route('admin.students.profile', $data['student']['id']) }}" class="btn btn-modern btn-primary-modern">
