...
@section('title', 'Projets Design Graphique - Assignés')
...
<div class="container-fluid py-4">
    ...
    <!-- Projects Table -->
    @php
        $projects = $groupedAssignments['Design Graphique'] ?? collect();
    @endphp
        ...
        <div class="card" style="background-color: #1e293b; border: 1px solid #334155;">
            <div class="card-header d-flex justify-content-between align-items-center" style="background-color: #0f172a; border-bottom: 1px solid #334155;">
                <h5 class="mb-0 text-white">
                    <i class="fas fa-graduation-cap me-2"></i>Design Graphique
                </h5>
