                        ...
                        <div class="col-lg-4">
                            <div class="p-3 rounded" style="background: rgba(255,255,255,0.05);">
                                ...
                                <div class="mb-3">
                                    ...
                                    <a href="{{ route('admin.students.show', $project->user->id) }}" class="btn btn-outline-info btn-sm mt-2 w-100">
            ...
            <div class="dashboard-card text-white">
                ...
                <div class="card-body">
                    <div class="d-flex flex-wrap gap-3 justify-content-center">
                        ...
                        <a href="{{ route('admin.students.show', $project->user->id) }}" class="btn btn-info">
                        ...
                        <form action="{{ route('admin.projects.delete', $project->id) }}" method="POST" class="d-inline" onsubmit="return handleDeleteSubmit(event)">
                            @csrf
                            @method('DELETE')
