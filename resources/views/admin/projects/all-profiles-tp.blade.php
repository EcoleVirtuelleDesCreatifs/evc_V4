...
<style>
    ...
    .project-item.assigned { border-left-color: #f59e0b; }
    .project-item.submitted { border-left-color: #3b82f6; }
    .project-item.validated { border-left-color: #10b981; }
    .project-item.rejected { border-left-color: #ef4444; }
...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('admin.projets.design-cm.to-send') }}" class="btn btn-primary">
        ...
        <div class="profile-accordion">
            ...
            <div class="profile-content" id="profile-{{ $loop->index }}">
                <div class="profile-body">
                    @if(isset($profile['projects']['assigned']))
                        <h4 style="color: #1a202c !important;"><i class="fas fa-folder-open" style="color: #f59e0b;"></i> À Faire ({{ $profile['projects']['assigned']->count() }})</h4>
                        @foreach($profile['projects']['assigned'] as $project)
                            <div class="project-item assigned">
                    ...
                    @if(isset($profile['projects']['submitted']))
                        <h4 class="mt-4" style="color: #1a202c !important;"><i class="fas fa-paper-plane" style="color: #3b82f6;"></i> Soumis ({{ $profile['projects']['submitted']->count() }})</h4>
                        @foreach($profile['projects']['submitted'] as $project)
                            <div class="project-item submitted">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h5 style="color: #1a202c !important; font-weight: 600;">{{ $project->title }}</h5>
                                        <p class="text-muted" style="color: #6b7280 !important;">{!! Str::limit(strip_tags($project->description), 120) !!}</p>
                    ...
                    @if(isset($profile['projects']['validated']))
                        <h4 class="mt-4" style="color: #1a202c !important;"><i class="fas fa-check-circle" style="color: #10b981;"></i> Validés ({{ $profile['projects']['validated']->count() }})</h4>
                        @foreach($profile['projects']['validated'] as $project)
                            <div class="project-item validated">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h5 style="color: #1a202c !important; font-weight: 600;">{{ $project->title }}</h5>
                                        <p class="text-muted" style="color: #6b7280 !important;">{!! Str::limit(strip_tags($project->description), 120) !!}</p>
                    ...
                    @if(isset($profile['projects']['rejected']))
                        <h4 class="mt-4" style="color: #1a202c !important;"><i class="fas fa-times-circle" style="color: #ef4444;"></i> Rejetés ({{ $profile['projects']['rejected']->count() }})</h4>
                        @foreach($profile['projects']['rejected'] as $project)
                            <div class="project-item rejected">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h5 style="color: #1a202c !important; font-weight: 600;">{{ $project->title }}</h5>
                                        <p class="text-muted" style="color: #6b7280 !important;">{!! Str::limit(strip_tags($project->description), 120) !!}</p>
