                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control modern-input @error('content') is-invalid @enderror" 
                                      ...
                                      placeholder="Description détaillée de l'actualité...">{{ old('content', $actualite->content) }}</textarea>
                            @error('content')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="card modern-card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <small class="text-muted"><span id="meta-title-count">{{ strlen($actualite->meta_title ?? '') }}</span>/60 caractères</small>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control modern-input" 
                                      ...
                                      placeholder="Description pour les moteurs de recherche" maxlength="160">{{ old('meta_description', $actualite->meta_description) }}</textarea>
                            <small class="text-muted"><span id="meta-desc-count">{{ strlen($actualite->meta_description ?? '') }}</span>/160 caractères</small>
                        </div>
