...
@section('content')
<div class="container-fluid pt-2 mt-2 pt-md-3 mt-md-3 px-0 px-md-4">
                    ...
                    <div class="d-flex align-items-start">
                        ...
                        <div class="flex-grow-1">
                            <h5 class="alert-heading mb-2">
                                ...
                                Accès Limité - Compte Expiré
                            </h5>
                            <p class="mb-2">
                                Votre période de formation de 4 mois a pris fin le <strong>{{ $expirationDate->format('d/m/Y') }}</strong>.
                            </p>
                            <div class="alert alert-light mb-2">
                                <h6 class="mb-2"><i class="fas fa-check-circle text-success me-2"></i>Ce que vous pouvez encore faire :</h6>
                                <ul class="mb-0 ps-3">
                                    <li>Consulter vos anciens travaux et projets</li>
                                    <li>Télécharger vos ressources précédemment acquises</li>
                                    <li>Accéder à votre profil et vos informations</li>
                                </ul>
                            </div>
                            <div class="alert alert-light mb-2">
                                <h6 class="mb-2"><i class="fas fa-times-circle text-danger me-2"></i>Accès restreint :</h6>
                                <ul class="mb-0 ps-3">
                                    <li>Nouvelles formations et mises à jour de contenu</li>
                                    <li>Nouveaux TP et projets</li>
                                    <li>Bibliothèque de ressources</li>
                                </ul>
                            </div>
                            <a href="#" class="btn btn-warning btn-sm">
                                <i class="fas fa-envelope me-1"></i>
                                Contacter l'administration pour renouveler
                            </a>
                        </div>
                    </div>
                </div>
            @elseif($isExpiringSoon)
                <div class="alert alert-warning border-0 shadow-sm d-flex align-items-center" role="alert">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <p class="mb-2">
                            Il vous reste <strong class="fs-4 text-danger">{{ $daysRemaining }} jours</strong> avant l'expiration de votre compte.
                        </p>
                        <small class="text-muted">
                            <i class="fas fa-calendar-alt me-1"></i>
                            Date d'expiration : <strong>{{ $expirationDate->format('d/m/Y') }}</strong>
                            | Compte créé le : {{ $accountCreatedAt->format('d/m/Y') }}
                        </small>
                    </div>
                </div>
            @else
                <div class="formation-duration-widget border-0 shadow-lg overflow-hidden" style="
                ...
                ">
                    ...
                    <div style="position: absolute; width: 100%; height: 100%; overflow: hidden; opacity: 0.1;">
                        <div class="floating-circle" style="position: absolute; width: 100px; height: 100px; background: white; border-radius: 50%; top: -20px; right: 50px; animation: float 6s ease-in-out infinite;"></div>
                        <div class="floating-circle" style="position: absolute; width: 60px; height: 60px; background: white; border-radius: 50%; bottom: 20px; left: 100px; animation: float 4s ease-in-out infinite 1s;"></div>
                        <div class="floating-circle" style="position: absolute; width: 80px; height: 80px; background: white; border-radius: 50%; top: 50%; right: 20%; animation: float 5s ease-in-out infinite 2s;"></div>
                    </div>
                    ...
                    <div class="p-4 position-relative" style="z-index: 1;">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div class="flex-grow-1 text-white">
                                ...
                                <p class="mb-3 fs-5" style="animation: slideInRight 0.8s ease-out;">
                                    Votre accès est valable pendant <strong style="
                                        font-size: 1.3rem;
                                        color: #fff;
                                ...
                                <!-- Compteur dynamique -->
                                <div class="countdown-box p-3 mb-3" style="
                                ...
                                ">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div>
                                            ...
                                            <div style="font-size: 2.5rem; font-weight: 800; line-height: 1; text-shadow: 2px 2px 8px rgba(0, 0, 0, 0.3);">
                                                {{ $daysRemaining }}
                                                <span style="font-size: 1.2rem; font-weight: 400;">jours</span>
                                            </div>
                                        </div>
                                        <div class="text-end">
                                            <div class="small opacity-90 mb-1">
                                                <i class="fas fa-calendar-alt me-1"></i>Expire le
                                            </div>
                                ...
                                <div class="mb-2">
                                    @php
                                        $totalDays = 120; // 4 mois ≈ 120 jours
                                ...
                                <!-- Message motivant -->
                                <div class="alert alert-light border-0 mb-0 mt-3" style="
                                ...
                                ">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div style="color: #333;">
                                            <strong>Conseil Pro :</strong> Maximisez votre apprentissage !
                                            Complétez vos TP et projets avant l'expiration pour valider vos compétences.
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <style>
                    @keyframes pulse-glow {
                        ...
                        50% { box-shadow: 0 0 40px rgba(118, 75, 162, 0.6), 0 0 60px rgba(240, 147, 251, 0.4); }
                    }
