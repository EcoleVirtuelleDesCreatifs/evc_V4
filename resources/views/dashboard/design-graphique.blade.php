                    ...
                    <div class="flex-grow-1">
                        ...
                        <div class="d-flex gap-2 flex-wrap justify-content-center justify-content-lg-start align-items-center">
                            @if(!$isExpired)
                                ...
                                <a href="{{ \Illuminate\Support\Facades\Route::has('student.appointments.index') ? route('student.appointments.index') : '#' }}" class="hero-cta secondary" style="width: 44px; height: 44px; padding: 0; border-radius: 50%; justify-content: center;" title="Prendre rendez-vous">
