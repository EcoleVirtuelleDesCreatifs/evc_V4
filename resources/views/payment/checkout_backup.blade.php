...
<body>
                ...
                <form action="{{ route('payment.process') }}" method="POST" id="paymentForm">
                    ...
                    <div class="mb-4">
                        <label class="form-label">
                            <i class="fas fa-phone me-2"></i>Numéro de téléphone (optionnel)
                        </label>
                        <input type="tel" name="phone_number" class="form-control"
                               placeholder="+225 XX XX XX XX XX"
                               value="{{ $candidate->whatsapp ?? '' }}">
                        <small class="text-muted">
                            Entrez le numéro pour Mobile Money ou laissez vide pour carte bancaire
                        </small>
                    </div>
                    ...
                    <div class="info-box">
                        ...
                        <small>
                            ...
                            1️⃣ Redirection vers notre plateforme de paiement ultra-sécurisée CinetPay<br>
                            2️⃣ Choisissez votre moyen de paiement favori (Mobile Money, Carte...)<br>
                            3️⃣ Validez votre paiement en toute confiance<br>
                            4️⃣ Recevez instantanément votre lien de création de compte par email 📧
                        </small>
                    </div>

                    <button type="submit" class="btn-pay" id="btnPay">
                        <i class="fas fa-lock me-2"></i>
                        💳 Confirmer Mon Inscription Maintenant
                    </button>
                </form>
    ...
    <script>
        document.getElementById('paymentForm').addEventListener('submit', function() {
            ...
            btn.disabled = true;
            btn.innerHTML = '<i class="fas fa-spinner fa-spin me-2"></i>Redirection en cours...';
        });
    </script>
</body>
</html>
