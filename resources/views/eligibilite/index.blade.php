...
<style>
    ...
    .saop-page{min-height:100vh;padding:300px 20px 70px;max-width:1100px;margin:0 auto}
    ...
    @media(max-width:760px){.saop-page{padding:300px 16px 50px}.saop-hero{padding-top:0}.saop-card{padding:22px}.form-grid{grid-template-columns:1fr}.timer-bar{top:86px;align-items:flex-start;flex-direction:column}.timer-value{font-size:22px}}
</style>
@endpush
