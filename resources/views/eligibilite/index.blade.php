...
<style>
    ...
    .timer-bar{position:sticky;top:92px;z-index:1000;display:flex;justify-content:space-between;align-items:center;gap:14px;padding:16px 18px;border-radius:16px;background:rgba(15,23,42,.96);border:1px solid rgba(255,152,0,.35);box-shadow:0 18px 45px rgba(0,0,0,.25);margin-bottom:22px}.timer-label{color:var(--text-secondary);font-weight:700}.timer-value{font-size:24px;font-weight:900;color:var(--primary)}.timer-warning{color:#fca5a5!important}
    ...
    @media(max-width:760px){.saop-page{padding:140px 16px 50px}.saop-hero{padding-top:38px}.saop-card{padding:22px}.form-grid{grid-template-columns:1fr}.timer-bar{top:86px;align-items:flex-start;flex-direction:column}.timer-value{font-size:22px}}
</style>
@endpush
