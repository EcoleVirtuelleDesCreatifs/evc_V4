...
@section('title', 'Bilé Bossombra - Formateur Principal EVC | Expert Digital')

@section('description', 'Découvrez le parcours de Bilé Bossombra, Manager Digital et formateur principal de l\'École Virtuelle des Créatifs à Abidjan.')

@section('keywords', 'Bilé Bossombra, formateur digital Abidjan, expert marketing digital Côte d\'Ivoire')
