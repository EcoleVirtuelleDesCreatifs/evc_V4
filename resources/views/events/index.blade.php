...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-md-3 mb-3">
            <div class="card text-center h-100">
                <div class="card-body">
                    ...
                    <small class="text-muted mb-3">Webinaires</small>
                    <div class="mt-auto">
        ...
        <div class="col-md-3 mb-3">
            <div class="card text-center h-100">
                <div class="card-body">
                    <i class="fas fa-broadcast-tower fa-2x mb-2" style="color: var(--secondary-color);"></i>
                    <h3 style="color: var(--secondary-color);">2</h3>
                    <small class="text-muted mb-3">Lives</small>
                    <div class="mt-auto">
        ...
        <div class="col-md-3 mb-3">
            <div class="card text-center h-100">
                <div class="card-body">
                    ...
                    <h3 style="color: var(--success-color);">15</h3>
                    <small class="text-muted mb-3">Replays</small>
                    <div class="mt-auto">
        ...
        <div class="col-md-3 mb-3">
            <div class="card text-center h-100">
                <div class="card-body">
                    <i class="fas fa-calendar-check fa-2x mb-2" style="color: var(--accent-color);"></i>
                    <h3 style="color: var(--accent-color);">21</h3>
                    <small class="text-muted mb-3">Total Events</small>
                    <div class="mt-auto">
                        <button class="btn btn-secondary btn-sm w-100">
