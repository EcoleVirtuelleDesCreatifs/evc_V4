...
Route::get('/evc-store/{product:slug}', [App\Http\Controllers\StoreOrderController::class, 'show'])->name('evc.store.show');
...
Route::get('/jury/evaluation/draft', [JuryEvaluationController::class, 'loadDraft'])->name('jury.evaluation.draft');
...
Route::get('/evc/jury/evaluation/draft', [JuryEvaluationController::class, 'loadDraft'])->name('jury.evaluation.draft.evc');
...
Route::prefix('/evc/app/admin')->name('admin.')->middleware('admin.errors')->group(function () {
    ...
    Route::middleware('admin.auth')->group(function () {
        ...
        Route::put('/boutique/categories/{category}', [\App\Http\Controllers\Admin\BoutiqueController::class, 'updateCategory'])->name('boutique.categories.update');
        Route::delete('/boutique/categories/{category}', [\App\Http\Controllers\Admin\BoutiqueController::class, 'destroyCategory'])->name('boutique.categories.destroy');
        ...
        Route::post('/certification/eligibilite/{student}/validate-all', [App\Http\Controllers\Admin\CertificationEligibilityAdminController::class, 'validateAll'])->name('certification-eligibility.validate-all');
        ...
        Route::post('/students/{id}/assign-project', [\App\Http\Controllers\Admin\StudentAdminController::class, 'assignProject'])->name('students.assign-project');
